...
WITH stop_time_updates AS (
    SELECT *
    FROM `cal-itp-data-infra.mart_gtfs.fct_stop_time_updates`--{{ ref('fct_stop_time_updates') }}
    WHERE dt BETWEEN '2026-01-30' AND '2026-02-28' AND base64_url IN ('aHR0cHM6Ly9ndGZzcnQubWFyaW50cmFuc2l0LmNhZGF2bC5jb20vUHJvZmlsR3Rmc1J0Ml8wUlNQcm9kdWNlci1NVC9UcmlwVXBkYXRlLnBi',  'aHR0cHM6Ly9tYXJpbnRyYW5zaXQubmV0L2d0ZnMtcnQvdHJpcHVwZGF0ZXM=', 'aHR0cHM6Ly9hcGkuZ29zd2lmdC5seS9yZWFsLXRpbWUvbWFyaW4tdHJhbnNpdC9ndGZzLXJ0LXRyaXAtdXBkYXRlcw==', 'aHR0cHM6Ly9hcGkuNTExLm9yZy90cmFuc2l0L3RyaXB1cGRhdGVzP2FnZW5jeT1NQQ==')
),
