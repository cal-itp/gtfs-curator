...
These are developed in each section accompanying the charts and tables for each prediction accuracy metric.
...
### References
* [README - Intro and Definitions](https://analysis.dds.dot.ca.gov/rt_operator_metrics/)
* [Swiftly - Jan 2026](https://analysis.dds.dot.ca.gov/rt_operator_metrics/name-marin-swiftly-trip-update/operator-report-name-marin-swiftly-trip-update/index.html)
* [Bay Area 511 - Jan 2026](https://analysis.dds.dot.ca.gov/rt_operator_metrics/name-bay-area-511-marin-tripupdates/operator-report-name-bay-area-511-marin-tripupdate/index.html)
