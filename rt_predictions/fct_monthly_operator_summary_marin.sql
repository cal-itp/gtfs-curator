...
WITH daily_summary AS (
    SELECT *
    FROM `cal-itp-data-infra-staging.tiffany_mart_gtfs.fct_daily_schedule_rt_operator_summary_marin`
    WHERE service_date >= "2026-02-01" AND service_date < "2026-03-01"
),
